/// <reference path="E:\mhg_NewWebSite\ShuanZan_FineFrameWork\_FineFrameWork\ChinaWellDealersWeb\Error.html" />
/// <reference path="E:\mhg_NewWebSite\ShuanZan_FineFrameWork\_FineFrameWork\ChinaWellDealersWeb\Error.html" />
...
if (typeof jQuery === "undefined") {
               ...
               '<div class="mt-nav mt-nav-tools-right">' +
                   '<ul  class="layui-nav nav {nav-tabs}">' +
                       ...
                       '<li class="layui-nav-item">' +
                           '<a href="javascript:;" class="ss"><i style="font-size:16px;" class="icon-reorder"></i></a>' +
    ...
    $.fn.multitabs.defaults = {
        ...
        init : [{                                       
                ...
                url: '/Login/Welcome'             //链接，如为外链，强制为info页
            }],                                    //tabs in initial
        navBar : {
        ...
        language : {                                //language setting
            navBar : {
                ...
                showActivedTab : '显示激活“选项卡',          //show active tab
                closeAllTabs : '关闭所有选项卡',                //close all tabs
                closeOtherTabs : '关闭其他选项卡',            //close other tabs
            }
        },
